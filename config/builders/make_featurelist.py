...
name = '/home/pfuerst/master_thesis/software/BDT_energy_reconstruction/config/files/standard_feat.yaml'
...
name_no_E = '/home/pfuerst/master_thesis/software/BDT_energy_reconstruction/config/files/no_E_feat.yaml'
